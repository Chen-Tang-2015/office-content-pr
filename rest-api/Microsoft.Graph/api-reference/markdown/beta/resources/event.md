...
|:---------------|:--------|:----------|
|attendees|[Attendee](attendee.md) collection|The collection of attendees for the event. The collection of attendees for the event.|
|body|[ItemBody](itembody.md)|The body of the message associated with the event. The body of the message associated with the event.|
...
|categories|String collection|The categories associated with the event. The categories associated with the event.|
...
|location|[Location](location.md)|The location of the event. The location of the event.|
|organizer|[Recipient](recipient.md)|The organizer of the event. The organizer of the event.|
...
|recurrence|[PatternedRecurrence](patternedrecurrence.md)|The recurrence patern for the event. The recurrence patern for the event.|
...
|responseStatus|[ResponseStatus](responsestatus.md)|Indicates the type of response sent in response to an event message. Indicates the type of response sent in response to an event message.|
