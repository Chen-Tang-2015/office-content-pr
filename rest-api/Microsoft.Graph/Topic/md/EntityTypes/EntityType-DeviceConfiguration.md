...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | 
| `cloudPublicIssuerCertificates` | `Collection(Edm.Binary)` | `beta`, `alpha` | `false` | `n/a` | `true` | `true` |  |  | 
| `deletionTimestamp` | `Edm.DateTimeOffset` | `beta`, `alpha` | `true` | `n/a` | `true` | `true` |  |  | 
| `maximumRegistrationInactivityPeriod` | `Edm.Int32` | `beta`, `alpha` | `true` | `n/a` | `true` | `true` |  |  | 
| `objectId` (_Key_) | `Edm.String` | `beta`, `alpha` | `false` | `false` | `true` | `true` |  |  | 
| `objectType` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `publicIssuerCertificates` | `Collection(Edm.Binary)` | `beta`, `alpha` | `false` | `n/a` | `true` | `true` |  |  | 
| `registrationQuota` | `Edm.Int32` | `beta`, `alpha` | `true` | `n/a` | `true` | `true` |  |  | 
