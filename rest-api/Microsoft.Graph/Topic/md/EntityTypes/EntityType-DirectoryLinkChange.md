...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | :-- | 
| `associationType` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
...
| `sourceObjectId` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `sourceObjectType` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `sourceObjectUri` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `targetObjectId` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `targetObjectType` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
| `targetObjectUri` | `Edm.String` | `beta`, `alpha` | `true` | `false` | `true` | `true` |  |  | 
