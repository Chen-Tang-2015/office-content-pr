...
###Get the ExternalReferenceCollection extended resource

To get the ExternalReferenceCollection extended resource, submit an `HTTP GET` request of the following REST call syntax. 
